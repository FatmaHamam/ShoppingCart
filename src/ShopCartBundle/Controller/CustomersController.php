...
use ShopCartBundle\Entity\Customers;
use ShopCartBundle\Form\CustomersType;
...
class CustomersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ShopCartBundle:Customers')->findAll();
     ...
     * @Method("POST")
     * @Template("ShopCartBundle:Customers:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ShopCartBundle:Customers')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ShopCartBundle:Customers:edit.html.twig")
     */
